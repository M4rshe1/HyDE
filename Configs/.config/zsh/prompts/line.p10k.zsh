# Generated by Powerlevel10k configuration wizard on 2026-03-19 at 00:33 CET.
...
# 2 lines, disconnected, full frame, blue-ornaments, sparse, few icons, concise,
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  # 1. Base color for brackets (4)
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=4
  
  # 2. Path color for EVERY part of the path (5)
  # This covers the first part (~)
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=5
  # This covers the middle part (projects)
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=5
  # This covers any other middle segments that aren't shortened
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=5 
  
  # 3. The Template
  # Note: We wrap the brackets in %F{4} to force them to be the bracket color
  # because we just set the main DIR_FOREGROUND to 5.
  typeset -g POWERLEVEL9K_DIR_CONTENT_EXPANSION='%F{4}[ %F{5}%B$P9K_CONTENT%b%F{4} ]%f'
